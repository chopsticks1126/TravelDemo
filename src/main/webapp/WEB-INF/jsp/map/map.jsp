				...
				<table style="width: 100%;">
					<tr>
						...
						<td style="width: 34%; height: 100%;"><input type="text"
							id="addStartCityBtn" name="addStartCityBtn"/></td>
					</tr>
					<tr>
						...
						<td style="width: 34%; height: 100%;"><input type="text"
							id="addPassCityBtn" name="addPassCityBtn"/></td>
					</tr>
				</table>
			</div>
			</form>
...
<!-- <script type="text/javascript" src="../jslib/map/map.js"></script> -->
...
//定义全局变量
	...
	var urlall ="../CommtentController/";
//初始方法的加载
function onload(){
	//后台回去最新数据
	var url ="../CommtentController/ajaxGetAll.do";
					$.ajax({
						type:"POST",
						url:url,
						dataType:"html",
